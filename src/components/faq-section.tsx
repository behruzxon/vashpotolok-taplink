  ...
  return (
    <section aria-labelledby="faq-title">
      ...
      <ul className="flex flex-col gap-2">
        {items.map((item) => (
          <li key={item.id}>
            <details className="group relative overflow-hidden rounded-2xl border border-line-soft bg-bg-glass-strong backdrop-blur-md transition-colors duration-300 open:border-line-strong">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-3 p-3.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg-base">
                ...
                <span
                  aria-hidden
                  className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/[0.06] text-ink-secondary transition-transform duration-300 group-open:rotate-180 group-open:bg-brand-accent-soft group-open:text-brand-accent-glow"
                >
      ...
      <a
        ...
        className="mt-3 flex min-h-[52px] items-center justify-center gap-2 rounded-2xl border border-line-soft bg-bg-glass-strong px-4 py-3 text-[14px] font-semibold text-ink-primary backdrop-blur-md transition-colors hover:bg-white/[0.10] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg-base"
      >
        <svg viewBox="0 0 24 24" className="h-4 w-4 text-brand-accent-glow" fill="currentColor" aria-hidden>
