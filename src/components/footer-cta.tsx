  ...
  return (
    <footer className="pt-2">
      <GlassCard glow className="relative overflow-hidden p-5 text-center">
        ...
        <span
          aria-hidden
          className="pointer-events-none absolute -left-16 -bottom-16 h-40 w-40 rounded-full bg-call/10 blur-3xl"
        />
        <div className="relative">
          <div className="mx-auto inline-flex items-center gap-1.5 rounded-full border border-brand-accent/25 bg-brand-accent-soft px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.22em] text-brand-primary">
